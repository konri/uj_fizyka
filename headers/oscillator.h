...
protected:
    double ks;   // współczynnik sprężystości
    double kd;   // współczynnik tlumienia sprezystosci
    ...
    bill::vector spring_force(std::shared_ptr<oscillator> neighbor, double spring_length);

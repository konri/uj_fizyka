...
namespace bill {
    ...
    bill::BillIntegrator HollyWood = [](std::pair<bill::vector, bill::vector> PhasePoint0,
                                        std::pair<bill::vector, bill::vector> PhasePointM, bill::vector Force,
                                        double step) {
    ...
    bill::BillIntegrator Euler = [](std::pair<bill::vector, bill::vector> PhasePoint0,
                                    std::pair<bill::vector, bill::vector> PhasePointM, bill::vector Force,
                                    double step) {
    ...
    bill::BillIntegrator ModEuler = [](std::pair<bill::vector, bill::vector> PhasePoint0,
                                       std::pair<bill::vector, bill::vector> PhasePointM, bill::vector Force,
                                       double step) {
    ...
    bill::BillIntegrator Verlet = [](std::pair<bill::vector, bill::vector> PhasePoint0,
                                     std::pair<bill::vector, bill::vector> PhasePointM, bill::vector Force,
                                     double step) {

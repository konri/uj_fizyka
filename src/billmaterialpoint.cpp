...
bill::BillMaterialPoint::BillMaterialPoint(bill::BillIntegrator algorithm, bill::vector position,
...
void bill::BillMaterialPoint::x(bill::vector new_x) {
    ...
    past = std::pair<bill::vector, bill::vector>(std::get<0>(present) - std::get<1>(present) * step,
                                                 std::get<1>(present));
}
...
//        bill::vector pos = point->position();
//       // std::cout << pos[0] << ", " << pos[1] << ", " << pos[2] << std::endl;
//    }

//    for (auto &obstacle : obstacles) {
//        std::cout << obstacle->func() << std::endl;
//    }
